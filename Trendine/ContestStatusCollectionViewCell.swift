//
//  ContestStatusCollectionViewCell.swift
//  Trendin
//
...
class ContestStatusCollectionViewCell: UICollectionViewCell {
    ...
    func setUpViews(){
        ...
        likesLabel.leftAnchor.constraint(equalTo: likeButton.rightAnchor, constant: 5).isActive = true
