...
class NearByCollectionViewCell: UICollectionViewCell {
    ...
    let profileImageView: UIImageView = {
        ...
        imageV.image = UIImage(named: "biz")
    ...
    func setUpViews(){
        ...
        usernameLabel.topAnchor.constraint(equalTo: self.blurView.topAnchor,constant: 8).isActive = true
        ...
        AddUserButton.bottomAnchor.constraint(equalTo: blurView.bottomAnchor, constant: -8).isActive = true
        AddUserButton.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        AddUserButton.widthAnchor.constraint(equalToConstant: 100).isActive = true
        AddUserButton.heightAnchor.constraint(equalToConstant: 20).isActive = true
        ...
        distanceLabel.topAnchor.constraint(equalTo: usernameLabel.bottomAnchor).isActive = true
        distanceLabel.centerXAnchor.constraint(equalTo: blurView.centerXAnchor).isActive = true
        distanceLabel.widthAnchor.constraint(equalTo: blurView.widthAnchor).isActive = true
