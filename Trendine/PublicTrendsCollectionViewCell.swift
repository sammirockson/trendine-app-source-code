//
//  PublicTrendsCollectionViewCell.swift
//  Trendine
//
...
class PublicTrendsCollectionViewCell: UICollectionViewCell {
    ...
    let captionTextView: UITextView = {
        ...
        captionTextV.isSelectable = false
    ...
    let videoCaptionTextView: UITextView = {
        let captionTextV = UITextView()
        captionTextV.font = UIFont.systemFont(ofSize: 18)
        captionTextV.textColor = UIColor.darkGray
        captionTextV.backgroundColor = UIColor.clear
        captionTextV.isScrollEnabled = false
        captionTextV.isEditable = false
...
//        addSubview(optionsButton)
        ...
        controlsContainerView.addSubview(playButtonContaierView)
        ...
        playButtonContaierView.centerXAnchor.constraint(equalTo: controlsContainerView.centerXAnchor).isActive = true
        playButtonContaierView.centerYAnchor.constraint(equalTo: controlsContainerView.centerYAnchor).isActive = true
...
//        
        usernameLabel.rightAnchor.constraint(equalTo: locationLabel.leftAnchor, constant: -8).isActive = true
        ...
        locationLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -5).isActive = true
        locationLabel.topAnchor.constraint(equalTo: profileImage.topAnchor, constant: 10).isActive = true
        locationLabel.widthAnchor.constraint(equalToConstant: 80).isActive = true
        locationLabel.heightAnchor.constraint(equalToConstant: 12).isActive = true
        
//        locationLabel.rightAnchor.constraint(equalTo: optionsButton.leftAnchor, constant: -8).isActive = true
//        locationLabel.leftAnchor.constraint(equalTo: profileImage.rightAnchor, constant: 8).isActive = true
//        locationLabel.centerYAnchor.constraint(equalTo: profileImage.centerYAnchor).isActive = true
